function gameStart(
  ...
  let chatLog = $("chatLog"),
    chatInput = $("chatInput"),
    guessWordChatLog = $("guessWordChatLog"),
    guessWordInput = $("guessWordChatInput"),
  ...
  let downEvent = isTouchSupported
    ? "touchstart"
    : isPointerSupported
    ? "pointerdown"
    ...
    ? "MSPointerDown"
    : "mousedown";
  let moveEvent = isTouchSupported
    ? "touchmove"
    : isPointerSupported
    ? "pointermove"
    : isMSPointerSupported
